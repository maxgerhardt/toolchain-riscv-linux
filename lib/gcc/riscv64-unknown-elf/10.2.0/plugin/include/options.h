...
enum opt_code
{
  ...
  OPT_mshorten_memrefs = 1609,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1610,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1611,                  /* -mstrict-align */
  OPT_mtune_ = 1612,                         /* -mtune= */
  OPT_n = 1613,                              /* -n */
  OPT_name_sort = 1614,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1615,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1616,              /* -no-integrated-cpp */
  OPT_no_pie = 1617,                         /* -no-pie */
  OPT_nocpp = 1618,                          /* -nocpp */
  OPT_nodefaultlibs = 1619,                  /* -nodefaultlibs */
  OPT_nolibc = 1620,                         /* -nolibc */
  OPT_nophoboslib = 1621,                    /* -nophoboslib */
  OPT_nostartfiles = 1622,                   /* -nostartfiles */
  OPT_nostdinc = 1623,                       /* -nostdinc */
  OPT_nostdinc__ = 1624,                     /* -nostdinc++ */
  OPT_nostdlib = 1625,                       /* -nostdlib */
  OPT_o = 1626,                              /* -o */
  OPT_objects = 1627,                        /* -objects */
  OPT_p = 1628,                              /* -p */
  OPT_pass_exit_codes = 1629,                /* -pass-exit-codes */
  /* OPT_pedantic = 1630, */                 /* -pedantic */
  OPT_pedantic_errors = 1631,                /* -pedantic-errors */
  OPT_pg = 1632,                             /* -pg */
  OPT_pie = 1633,                            /* -pie */
  OPT_pipe = 1634,                           /* -pipe */
  OPT_print_file_name_ = 1635,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1636,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1637,          /* -print-multi-directory */
  OPT_print_multi_lib = 1638,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1639,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1640,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1641,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1642,               /* -print-prog-name= */
  OPT_print_search_dirs = 1643,              /* -print-search-dirs */
  OPT_print_sysroot = 1644,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1645,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1646,                    /* -print-value */
  OPT_quiet = 1647,                          /* -quiet */
  OPT_r = 1648,                              /* -r */
  OPT_remap = 1649,                          /* -remap */
  OPT_reverse_sort = 1650,                   /* -reverse-sort */
  OPT_s = 1651,                              /* -s */
  OPT_save_temps = 1652,                     /* -save-temps */
  OPT_save_temps_ = 1653,                    /* -save-temps= */
  OPT_shared = 1654,                         /* -shared */
  OPT_shared_libgcc = 1655,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1656,               /* -shared-libphobos */
  OPT_size_sort = 1657,                      /* -size-sort */
  /* OPT_specs = 1658, */                    /* -specs */
  OPT_specs_ = 1659,                         /* -specs= */
  OPT_static = 1660,                         /* -static */
  OPT_static_libasan = 1661,                 /* -static-libasan */
  OPT_static_libgcc = 1662,                  /* -static-libgcc */
  OPT_static_libgfortran = 1663,             /* -static-libgfortran */
  OPT_static_libgo = 1664,                   /* -static-libgo */
  OPT_static_liblsan = 1665,                 /* -static-liblsan */
  OPT_static_libmpx = 1666,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1667,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1668,               /* -static-libphobos */
  OPT_static_libstdc__ = 1669,               /* -static-libstdc++ */
  OPT_static_libtsan = 1670,                 /* -static-libtsan */
  OPT_static_libubsan = 1671,                /* -static-libubsan */
  OPT_static_pie = 1672,                     /* -static-pie */
  /* OPT_std_c__03 = 1673, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1674, */                /* -std=c++0x */
  OPT_std_c__11 = 1675,                      /* -std=c++11 */
  OPT_std_c__14 = 1676,                      /* -std=c++14 */
  OPT_std_c__17 = 1677,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1678, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1679, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1680, */                /* -std=c++20 */
  OPT_std_c__2a = 1681,                      /* -std=c++2a */
  OPT_std_c__98 = 1682,                      /* -std=c++98 */
  OPT_std_c11 = 1683,                        /* -std=c11 */
  OPT_std_c17 = 1684,                        /* -std=c17 */
  /* OPT_std_c18 = 1685, */                  /* -std=c18 */
  /* OPT_std_c1x = 1686, */                  /* -std=c1x */
  OPT_std_c2x = 1687,                        /* -std=c2x */
  /* OPT_std_c89 = 1688, */                  /* -std=c89 */
  OPT_std_c90 = 1689,                        /* -std=c90 */
  OPT_std_c99 = 1690,                        /* -std=c99 */
  /* OPT_std_c9x = 1691, */                  /* -std=c9x */
  OPT_std_f2003 = 1692,                      /* -std=f2003 */
  OPT_std_f2008 = 1693,                      /* -std=f2008 */
  OPT_std_f2008ts = 1694,                    /* -std=f2008ts */
  OPT_std_f2018 = 1695,                      /* -std=f2018 */
  OPT_std_f95 = 1696,                        /* -std=f95 */
  OPT_std_gnu = 1697,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1698, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1699, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1700,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1701,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1702,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1703, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1704, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1705, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1706,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1707,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1708,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1709,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1710, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1711, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1712,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1713, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1714,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1715,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1716, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1717, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1718,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1719, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1720, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1721, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1722, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1723, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1724,                     /* -std=legacy */
  OPT_symbol_ = 1725,                        /* -symbol= */
  OPT_symbolic = 1726,                       /* -symbolic */
  OPT_t = 1727,                              /* -t */
  OPT_time = 1728,                           /* -time */
  OPT_time_ = 1729,                          /* -time= */
  OPT_traditional = 1730,                    /* -traditional */
  OPT_traditional_cpp = 1731,                /* -traditional-cpp */
  OPT_tree_stats = 1732,                     /* -tree-stats */
  OPT_trigraphs = 1733,                      /* -trigraphs */
  OPT_type_stats = 1734,                     /* -type-stats */
  OPT_u = 1735,                              /* -u */
  OPT_undef = 1736,                          /* -undef */
  OPT_v = 1737,                              /* -v */
  OPT_version = 1738,                        /* -version */
  OPT_w = 1739,                              /* -w */
  OPT_wrapper = 1740,                        /* -wrapper */
  OPT_x = 1741,                              /* -x */
  OPT_z = 1742,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
